...
更新：2026-07-28（**负债/房贷建模**收口：①judge 决策口径由 corpus 改为净资产(net_assets)，负债真正参与判定，修复 §4.4 line360 口径 bug；②融资购房模式（financed_amount 拆首付+房贷，判定看流动安全垫+月供可覆盖性）；③customize 支持负债/刚性支出增删 + 记录购房落账；227 单测）
