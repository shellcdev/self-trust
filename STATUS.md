...
更新：2026-07-28（**§7.3 第三方导入 #1 修复**：`compute_candidates` 加 `provided` 标记 + `confirm_import` 仅覆盖「来源显式提供」或「人工修正」的分类，CSV 缺类不再静默清空已录入负债/刚性；手动局部修正同理；241 单测）
